...
# =========================================================
# 파싱한 txt 파일 위치
parent_dir = '../NewData/AllData/2.parsed/old/'
# 복셀 npz 파일 저장 위치
extract_path = '../NewData/AllData/3.voxel/'
...
def parse_RF_files(parent_dir, cls, file_ext='*.txt'):
    print(cls)
    features =np.empty((0, 27, 10, 32, 32))
    labels = []
...
for cls in classes:
    features, labels = parse_RF_files(parent_dir, cls)
